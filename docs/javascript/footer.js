...
footer.innerHTML = `
    <footer>
        ...
        <div class="container px-3 mt-5 mb-4">
            <h2 data-aos="fade-up"  class="pb-1 clashBold pt-1 text-center" style="font-size: clamp(30px, 6vw, 56px);">Get in Touch</h2>
            <p data-aos="fade-up"  class="text-center mx-auto" style="max-width: 820px;">
            ...
            <form data-aos="fade-up"  class="border d-flex align-items-center justify-content-center rounded mx-auto mt-5 p-2 mb-5"
